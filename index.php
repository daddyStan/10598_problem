...
function getResult($num)
{
    ...
    for ($i = 0; $i < 65536; $i++) {
        ...
        if(eval($str) == $num){
            return " \n Сочетание арифметических знаков и упорядоченных чисел от 1 до 9 вернёт $num в следующей комбинации: " .
                $preEvals . " \n";
        }

    }

    return "Для числа $num невозможно найти сочетание арифметических знаков (+,-,*,/) и упорядоченных чисел от 1 до 9. \n";
}
